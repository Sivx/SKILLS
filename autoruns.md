...
"chain": [
  ...
  { "level": 2, "role": "boss",    "path": "C:/dev/ApexTrader_boss_boss", "sessionId": "cse_c", "startedAt": "2026-08-05T23:02:00Z", "drives": "cse_b" }
]
```
...
**The hierarchy is the folder name.** Level 0 is the project. Each level up appends `_boss`:
...
Boss folders are scratch — they hold a `CLAUDE.md` and the operator skill, nothing else. They
are not the project and must never be given the project's path.
